...
<rdf:Description rdf:about="#Compartment_1">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_0" name="MPcis" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#Metabolite_1">
      ...
      <Metabolite key="Metabolite_2" name="Pcis" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_2">
      ...
      <Metabolite key="Metabolite_3" name="MPtrans" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_3">
      ...
      <Metabolite key="Metabolite_4" name="Pcis" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_4">
      ...
      <Metabolite key="Metabolite_5" name="Ptrans" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_5">
      ...
      <Metabolite key="Metabolite_6" name="Ptrans" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_5">
      ...
      <ModelValue key="ModelValue_6" name="k_cis_trans" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#Reaction_2">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4674" name="k2" value="0.00154785"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
...
<rdf:Description rdf:about="#Reaction_3">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4677" name="k2" value="0.00154785"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[cell],Vector=Metabolites[MPcis]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[cell],Vector=Metabolites[M]" value="12970727654518400" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[cell],Vector=Metabolites[Pcis]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[cell],Vector=Metabolites[MPtrans]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[syringe],Vector=Metabolites[Pcis]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[cell],Vector=Metabolites[Ptrans]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[syringe],Vector=Metabolites[Ptrans]" value="6.5460670061200002e+20" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 12970727654518400 0 0 0 0 0 6.5460670061200002e+20 4 10 0.5 0.0015478502080000002 0.00020709999999999999 1 0.20000000000000001 2 2 0.0040000000000000001 0.38696255200000002 20 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <ListOfReports>
    ...
    <Report key="Report_20" name="LinkerReport" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
      </Comment>
      <Body>
