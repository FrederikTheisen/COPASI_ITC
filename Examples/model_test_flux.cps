...
<!-- generated with COPASI 4.39 (Build 272) (http://www.copasi.org) at 2026-02-05T22:10:42Z -->
...
<rdf:Description rdf:about="#Compartment_3">
      ...
      <Compartment key="Compartment_2" name="syringe" simulationType="fixed" dimensionality="3" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Compartment_2">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_7" name="A" simulationType="reactions" compartment="Compartment_3" addNoise="false">
      </Metabolite>
      <Metabolite key="Metabolite_6" name="B" simulationType="reactions" compartment="Compartment_3" addNoise="false">
      </Metabolite>
      <Metabolite key="Metabolite_5" name="A" simulationType="reactions" compartment="Compartment_2" addNoise="false">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_5" name="koff" simulationType="assignment" addNoise="false">
        <Expression>
          1000
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_4" name="kon" simulationType="assignment" addNoise="false">
        <Expression>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_1" name="reaction" reversible="true" fast="false" addNoise="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5764" name="k1" value="0.1"/>
          <Constant key="Parameter_4598" name="k2" value="0.1"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[koff]" value="1000" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[kon]" value="1000" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[reaction]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[reaction],ParameterGroup=Parameters,Parameter=k2" value="1000" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 0 1000 1000 6.02214076e+19 0.00020000000000000001 1 1 
    </InitialState>
  </Model>
  <ListOfTasks>
